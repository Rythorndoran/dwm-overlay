...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsChinaRed();   // best used with borders and a custom, thicker font
    IMGUI_API void          StyleColorsSkyFly();   // best used with borders and a custom, thicker font
    IMGUI_API void          StyleColorsOrangeNew();   // best used with borders and a custom, thicker font
    IMGUI_API void          StyleColorsLightBlue();   // best used with borders and a custom, thicker font
    IMGUI_API void          StyleColorsPurCool();   // best used with borders and a custom, thicker font
    ...
    IMGUI_API void          DrawRectRainbow(float flSpeed);
    IMGUI_API void          DrawRainbowLine(const ImVec2& p1, const ImVec2& p2, float thickness, float flSpeed, float& flRainbow);
